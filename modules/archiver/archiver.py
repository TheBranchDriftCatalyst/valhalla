...
from db.s3_storage_connector import S3StorageConnector
...
class Archiver:
    def __init__(self, config, db):
        ...
        It sets up the instance variables that will be used by other functions in the class.


        :param self: Represent the instance of the class
        :param config: Pass in the configuration settings from the config
        :param db: Connect to the mongodb database
        :return: Nothing
        :doc-author: Trelent
        """
